                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item">
                                    <a href="addCategory.php" class="sidebar-link">
                                        ...
                                        <span class="hide-menu"> اضافة قسم </span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="showCategory.php" class="sidebar-link">
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item">
                                    <a href="addNews.php" class="sidebar-link">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link has-arrow waves-effect waves-dark" href="user.php" aria-expanded="false">
                                <i class="ti-bookmark"></i>
                                <span class="hide-menu">المستخدم </span>
                            </a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item">
                                    <a href="user.php" class="sidebar-link">
                                        <i class="mdi mdi-book-multiple"></i>
                                        <span class="hide-menu"> عرض المستخدمين
                                         </span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
